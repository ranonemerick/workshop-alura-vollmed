...
public class PacienteController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemPaciente>> listar(@PageableDefault(size = 10, sort = {"nome"}) Pageable pagincao) {
        var page = repository.findAll(pagincao).map(DadosListagemPaciente::new);
